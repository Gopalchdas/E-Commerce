...
const handleLogout = async () => {
 ...
 return (
    <div className='sidebar' style={!isAuthenticated?{display:'none'}:{display:'flex'}} >
        ...
        <Link to={'/doctors'} className='li' onClick={handleShow}><img src={list} />Products</Link>
        <Link to={'/addnewadmin'} className='li' onClick={handleShow}><img src={addAdmin} /> Add Admin</Link>
        <Link to={'/addnewdoctor'} className='li' onClick={handleShow}><img src={te} />Add Product</Link>
        <Link to={'/messages'} className='li' onClick={handleShow}><img src={message} />Subscribers</Link>
